...
using System.Text;
using authWebApi.Authentication;
...
public class AuthenticationController : ControllerBase
{
    ...
    public AuthenticationController(UserManager<TodoUser> userManager, IConfiguration configuration, ILogger<AuthenticationController> logger)
    {
